        ...
        <div className="max-w-5xl mx-auto px-4 md:px-6 py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <div>
              ...
              <p className="text-sm opacity-80 mb-4">We’re happy to help. Whether you have a question about your order, or need help with product care — send us a message and we’ll respond within 1-2 business days.</p>
