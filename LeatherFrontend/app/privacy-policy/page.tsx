    ...
    <>
      ...
      <main className="bg-background min-h-screen">
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-12">
          ...
          <p className="text-sm opacity-80">For any questions about privacy or data removal, contact us at <a className="underline" href="mailto:info@flexleather.com">info@theflexleather.com</a>.</p>
        </div>
      </main>
      <Footer />
    </>
